...
Sava a copy of pre-processed COVID data
```{r}
...
2. Retail & Recreation - shows clear recovery since 2021 but still under pre-covid level. Manhattan is heavily impacted and the other 4 boroughs are similier.
3. Grocery and Pharmacy - leaset impacted category but still slightly under water
4. Parks - Seasonality with peaks in summer and early fall time. Brookly and Queens have very high variations by seasonality, but mobility are still relatively lower than the baseline period in each year.
5. Transit Stations - Still suffering large decreases from baseine across boroughs
6. Workplaces - largest impacted category
7. Residential - increase since COVID. Largest increase was in H1 2020, and show decreasing trends
...
2. Correlations between mobility change and COVID stats gradually decreases.
